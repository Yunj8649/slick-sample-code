    ...
    var swiper2 = new Swiper('.swiper02', {
        ...
        on: {
            slideChangeTransitionEnd: function () {
                jQuery('.swiper02 .fadeInUp').addClass('before_hidden');
                jQuery('.swiper02 .fadeInUp').removeClass('fadeInUp');
                jQuery('.swiper02 .swiper-slide-active .txt_box').addClass('fadeInUp');
                jQuery('.swiper02 .swiper-slide-active .txt_box').removeClass('before_hidden');
            },
        }
	});
